...
procedure description(var A : AsciiArray);
...
procedure translate(var A : ASCIIArray; var axiom : ansistring);
...
procedure interpret(var A :ASCIIArray; var axiom : ansistring);
